...
begin
  ...
  begin
    nStr   := 'Select  Case when a.L_StockName Like ''%熟%'' then ''U、熟料'' when a.L_StockName like ''%骨料%'' then ''V、骨料'' '+
                    'when a.L_StockName like ''%袋%'' then ''D、袋装'' '+
              '      when a.L_StockName like ''%散%'' then ''D、散装'' else a.L_Type end L_Type, '+
