...
initialization
  ...
  begin
    NewClass(TMITQueryField,
      function(var nData: Pointer): TObject
      begin
        Result := TMITQueryField.Create;
      end);
    //xxxxx

    NewClass(TMITBusinessCommand,
      function(var nData: Pointer): TObject
      begin
        Result := TMITBusinessCommand.Create;
      end);
    //xxxxx

    NewClass(TMITBusinessWebChat,
      function(var nData: Pointer): TObject
      begin
        Result := TMITBusinessWebChat.Create;
      end);
    //xxxxx
  end;
end.
