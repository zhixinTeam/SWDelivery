...
const
  ...
  cFI_FrameDuanDaoQuery     = $0058;                 //短倒车辆放灰记录
  cFI_FrameOrderDtlHDQuery  = $0059;                 //采购核对
  cFI_FrameOrderImport      = $0060;                 //采购单据导入
  ...
  cFI_FormTransBase     = $1083;                     //短倒办理
  cFI_FormTransDetail   = $1084;                     //短倒办理
  cFI_FormMaterailTunnel= $1085;                     //原材料验收通道
...
begin
  ...
  //AddMenuModuleItem('MAIN_B05', cFI_FormCstmerCategoryInfo, mtForm);
