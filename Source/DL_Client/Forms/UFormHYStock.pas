...
begin
  ...
  try
    ...
    nSQL:= 'UPDate S_StockParamExt Set R_HHCValueBak=Replace(R_HHCValue,'','',CHAR(10)) Where R_PID='''+Trim(EditID.Text)+'''';
    FDM.ExecuteSQL(nSQL);

    nSQL:= 'UPDate S_StockParamExt Set R_HHCValueHJ='+nHValue+' Where R_PID='''+Trim(EditID.Text)+'''';
    FDM.ExecuteSQL(nSQL);
