...
begin
  ...
  try
    ...
    gDBConnManager.WorkerExec(FDBConn, nDelZTTruck);     //清理装车队列
...
begin
  ...
  begin                          
    ...
    begin
      ...
      begin
        ...
        if Fields[1].AsString = sFlag_Yes then      //  短倒销售类型
        begin
  ...
  try
    ...
    begin
      ...
      //gSysLoger.AddLog(TWorkerBusinessDuanDao, '短倒业务', FListA[nIdx]);
    end;
