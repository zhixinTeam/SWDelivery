...
type
  ...
  TMITBusinessNC = class(TMITPackerBase)
  protected
    procedure DoPackIn(const nData: Pointer); override;
    procedure DoUnPackIn(const nData: Pointer); override;
    procedure DoPackOut(const nData: Pointer); override;
...
//------------------------------------------------------------------------------
class function TMITBusinessNC.PackerName: string;
begin
  Result := sBus_BusinessNC;
end;

procedure TMITBusinessNC.DoPackIn(const nData: Pointer);
begin
  inherited;
...
procedure TMITBusinessNC.DoUnPackIn(const nData: Pointer);
begin
  inherited;
...
procedure TMITBusinessNC.DoPackOut(const nData: Pointer);
begin
  inherited;
...
procedure TMITBusinessNC.DoUnPackOut(const nData: Pointer);
begin
  inherited;
...
initialization
  ...
  gBusinessPackerManager.RegistePacker(TMITBusinessNC, sPlug_ModuleBus);
end.
